...
class DashboardApp:
    ...
    def run(self):
        ...
        selected_charts = st.multiselect(
            ...
            default=['Distribution', 'KPI Performance', 'Performance Multiple', 'Top vs Bottom Performers', 'Time to First Sale', 'CAR2CATPO Ratio', 'Average Residency', 'Cost of Hire', 'Attrition Count']
        )
